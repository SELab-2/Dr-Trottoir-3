...
import {IScheduleGarbageListItem, ScheduleGarbageListItem}
    from '@/components/elements/buildingdetailElement/scheduleGarbageListItem';
...
async function fetchSchedules(id: number, token: string) {
    ...
    const results: IScheduleGarbageListItem[] = [];
