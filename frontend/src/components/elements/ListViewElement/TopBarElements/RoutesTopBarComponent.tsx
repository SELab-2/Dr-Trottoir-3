...
type TopBarProps = {
    ...
    setSelectedActive: React.Dispatch<React.SetStateAction<number>>,
    allRoutes: ScheduleDefinition[],
};

export default function TopBar({sorttype, setSorttype, selectedRegions, setRegion, allRegions, amountOfResults,
    ...
    const handleChangeActive = (event: SelectChangeEvent) => {
        setSelectedActive(event.target.value as number);
    };
