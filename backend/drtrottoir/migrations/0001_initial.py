    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approval_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='issues_to_approve', to=settings.AUTH_USER_MODEL)),
                ('building', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='drtrottoir.building')),
        ...
        migrations.CreateModel(
            name='ScheduleDefinitionBuilding',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.AddField(
            ...
            name='buildings',
            field=models.ManyToManyField(through='drtrottoir.ScheduleDefinitionBuilding', to='drtrottoir.building'),
        ),
        migrations.AddField(
            model_name='scheduledefinition',
            name='location_group',
